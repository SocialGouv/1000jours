    ...
    const saveEpdsSurveyResults = async () => {
      ...
      await addReponseQuery({
        variables: {
          compteur: newCounter,
          genre: genderValue,
          reponse_1: answersScores[0],
          reponse_2: answersScores[1],
          reponse_3: answersScores[2],
          reponse_4: answersScores[3],
          reponse_5: answersScores[4],
          reponse_6: answersScores[5],
          reponse_7: answersScores[6],
          reponse_8: answersScores[7],
          reponse_9: answersScores[8],
          reponse_10: answersScores[9],
          score: result,
        },
      });
    };
